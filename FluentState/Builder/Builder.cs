    ...
    where TStimulus : struct
{
    ...
    /// <returns></returns>
    IBuilder<TState, TStimulus> WithState(TState state, Action<StateBuilder<TState, TStimulus>> configureState);
    ...
    /// <returns></returns>
    IBuilder<TState, TStimulus> WithEnterAction(Action<Transition<TState, TStimulus>> action);
    ...
    /// <returns></returns>
    IBuilder<TState, TStimulus> WithEnterAction<TAction>() where TAction : IAction<TState, TStimulus>, new();
    ...
    /// <param name="action"></param>
    /// <returns></returns>
    IBuilder<TState, TStimulus> WithEnterAction(IAction<TState, TStimulus> action);
    ...
    /// <param name="action"></param>
    /// <returns></returns>
    IBuilder<TState, TStimulus> WithLeaveAction(Action<Transition<TState, TStimulus>> action);
    ...
    /// <typeparam name="TAction"></typeparam>
    /// <returns></returns>
    IBuilder<TState, TStimulus> WithLeaveAction<TAction>() where TAction : IAction<TState, TStimulus>, new();
    ...
    /// <param name="action"></param>
    /// <returns></returns>
    IBuilder<TState, TStimulus> WithLeaveAction(IAction<TState, TStimulus> action);
    ...
    /// </summary>
    /// <returns></returns>
    IStateMachine<TState, TStimulus> Build();
}
    ...
    where TStimulus : struct
{
    ...
    private readonly IStateMachineFactory<TState, TStimulus> _factory;
    ...
    public Builder(TState initialState, IStateMachineFactory<TState, TStimulus> factory)
    {
        _initialState = initialState;
        _factory = factory;
    }

    public IBuilder<TState, TStimulus> WithState(TState state, Action<StateBuilder<TState, TStimulus>> configureState)
    {
    ...
    public IBuilder<TState, TStimulus> WithEnterAction(Action<Transition<TState, TStimulus>> action)
    {
        return WithEnterAction(new DelegateAction<TState, TStimulus>(action));
    }

    public IBuilder<TState, TStimulus> WithEnterAction<TAction>() where TAction : IAction<TState, TStimulus>, new()
    {
        return WithEnterAction(new TAction());
    }
    public IBuilder<TState, TStimulus> WithEnterAction(IAction<TState, TStimulus> action)
    {
    ...
    public IBuilder<TState, TStimulus> WithLeaveAction(Action<Transition<TState, TStimulus>> action)
    {
        return WithLeaveAction(new DelegateAction<TState, TStimulus>(action));
    }

    public IBuilder<TState, TStimulus> WithLeaveAction<TAction>() where TAction : IAction<TState, TStimulus>, new()
    {
        return WithLeaveAction(new TAction());
    }

    public IBuilder<TState, TStimulus> WithLeaveAction(IAction<TState, TStimulus> action)
    {
    ...
    public IStateMachine<TState, TStimulus> Build()
    {
